...
public class activityAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // EM TEMPO REAL O CADASTRO DE MAIS UM PACIENTE //
        com.google.firebase.firestore.FirebaseFirestore bancoDeDados = com.google.firebase.firestore.FirebaseFirestore.getInstance();
        ...
        android.widget.TextView tvContadorPacientes = findViewById(R.id.tv_numero_pacientes_ativos);

        // CONTADOR DE PACIENTES ATIVOS //
        if (tvContadorPacientes != null) {
            bancoDeDados.collection("Usuarios")
                    .whereEqualTo("tipo_perfil", "paciente") // Filtra apenas os pacientes reais
                    .addSnapshotListener((valor, erro) -> {
                        ...
                        if (valor != null) {
                            int totalPacientes = valor.size();

                            tvContadorPacientes.setText(String.valueOf(totalPacientes));
                        }
                    });
        }
