...
public class DashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Gameficação com o ID dos cadastrados //
        ...
        android.widget.TextView tvBoasVindas = findViewById(R.id.tv_ola_paciente);
                    ...
                    .addSnapshotListener(new EventListener<DocumentSnapshot>() {
                        ...
                        public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException error) {
                            if (documentSnapshot != null && documentSnapshot.exists()) {
                                ...
                                tvBoasVindas.setText("Olá, " + nomeDaNuvem + "!");

                                // Se for um paciente novo, o padrão será 5% //
                                Long progressoNuvem = documentSnapshot.getLong("progresso_diario");
                                int progressoAtual = (progressoNuvem != null) ? progressoNuvem.intValue() : 5;

                                progressBar.setProgress(progressoAtual);
                                tvProgressPercent.setText(progressoAtual + "%");
                            }
                        }
                    });
        }
    ...
    protected void onResume() {
        ...
        if (bottomNav != null) {
            ...
            // ATENÇÃO: Confirme se o ID do seu ícone Home no menu XML é "nav_home"
            android.view.MenuItem itemCasinha = menu.findItem(R.id.nav_inicio);

            if (itemCasinha != null) {
                itemCasinha.setChecked(true);
            }
        }
    }
}